...
<hr>
<p>
Змија е симулација на познатата игра Snake.<img src="http://i.imgur.com/lJ0hbmN.png?1" alt="snake" style="float:right;margin:0 5px 0 0;"></img> Со стрелките на тастатурата одредуваме во кој правец да се движи змијата (горе,
