...
<hr>
<p>
Змија е симулација на познатата игра Snake.<img src="http://i.imgur.com/lJ0hbmN.png?1" alt="snake" position="absolute"></img> Со стрелките на тастатурата одредуваме во кој правец да се движи змијата (горе,
